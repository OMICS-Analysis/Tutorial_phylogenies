...
```{r}
# Load a tree file
tree <- read.newick("data/example_phylo_Cmi.nwk")
tree$node.label <- round(as.numeric(tree$node.label), digits = 3)
#Convert tree information to tibble
...
# Cargar metadata
metadata <- readr::read_tsv("data/Experiment_Design_Cmi.tsv")
...
# Estos tibbles pueden ser convertidos nuevamente a arbol facilmante
