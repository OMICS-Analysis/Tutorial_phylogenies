...
tree <- read.newick("results/Example1_Cmi_root_d0001.nwk")
...
ggsave(
  filename = "results/Cmi_root_d0001/Cmi_root_d0001_states.png",
  plot = pphy,
  dpi = 300,
  width = 280,   # Ancho en mm
  height = 180,  # Alto en mm
  units = "mm"
)
...
ggsave(
  filename = "results/Cmi_root_d0001/Cmi_root_d0001_verticalTree.png",
  plot = t1,
  dpi = 300,
